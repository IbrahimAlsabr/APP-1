...
// char* afficher_txt_decodage(char str[], int cle) {

//         for (int i = 0; str[i] != '\0'; i++)
//         {
//             if (EST_MINUSCULE(str[i]))
//             {
//                 str[i] = DecodageLetrMinusc(str[i], cle);
//                 //printf("%c",DecodageLetrMinusc(str[i], cle));
//             }

//             else if (EST_MAJSCULE(str[i]))
//             {
//                 str[i] = DecodageLetrMaj(str[i], cle);
//                 //printf("%c",DecodageLetrMaj(str[i], cle));
//             }
//         }
