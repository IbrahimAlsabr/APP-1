...
/* 
 * Fonction pour supprimer la dernier lettre de chaine de caractere 
 */
...
/* 
 * Fonction pour mettre une lettre au debut d'une chane de caractere 
 */
...
/* 
 * pour mettre ensemble des lettres ala fin de chaine de caractere 
 */
...
/* 
 * Fonction principal de DecrypteMove (BayOfPigs)  
 */ 
